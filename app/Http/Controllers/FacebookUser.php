...
$data_get_link = file_get_contents("https://graph.facebook.com/v3.1/".$key['id']."?fields=id%2Cname%2Clink%2Ccategory%2products%2Cfan_count&access_token=".$access_token);
